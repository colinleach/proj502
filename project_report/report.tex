...
\begin{figure}
	\gridline{\fig{gz2_train_64.pdf}{0.4\textwidth}{(a)}
			  \fig{decals_train.pdf}{0.4\textwidth}{(b)}}
	\gridline{\fig{gz2_train_32.pdf}{0.4\textwidth}{(c)}
		      \fig{decals_train_2.pdf}{0.4\textwidth}{(d)}}
...
\begin{figure}
	\gridline{\fig{J110001.05+010644.0.pdf}{0.6\textwidth}{(a)}}
...
\begin{figure}
	\gridline{\fig{gz2_train_128.pdf}{0.4\textwidth}{}
			\fig{decals_train_bs128.pdf}{0.4\textwidth}{}}
